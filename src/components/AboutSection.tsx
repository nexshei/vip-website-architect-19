        ...
        <div className="text-center mb-16">
          <div className="relative inline-block">
            ...
            <img 
              ...
              className="relative w-48 h-48 sm:w-56 sm:h-56 lg:w-64 lg:h-64 object-cover object-top rounded-full border-4 border-luxury-gold shadow-2xl mx-auto mb-6 animate-scale-in"
            />
          </div>
